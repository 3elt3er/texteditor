...
var require_image_resize_min = __commonJS({
  "node_modules/quill-image-resize-module/image-resize.min.js"(exports, module) {
    !function(t, e) {
      ...
      return function(t) {
        ...
        function o(t2, e2, n2, l, f) {
          t2 !== e2 && a(e2, function(a2, c2) {
            if (u(a2)) f || (f = new r()), s(t2, e2, c2, n2, o, l, f);
            else {
        ...
        var o = n(47), r = n(2), i = Object.prototype, a = i.hasOwnProperty, s = i.propertyIsEnumerable, u = o(/* @__PURE__ */ function() {
          return arguments;
        }()) ? o : function(t2) {
        ...
        var d = window.Quill.imports.parchment, h = new d.Attributor.Style("float", "float"), y = new d.Attributor.Style("margin", "margin"), v = new d.Attributor.Style("display", "display"), b = function(t2) {
          function e2() {
            var t3, n2, i2, a2;
            o(this, e2);
            for (var u2 = arguments.length, l2 = Array(u2), p2 = 0; p2 < u2; p2++) l2[p2] = arguments[p2];
            return n2 = i2 = r(this, (t3 = e2.__proto__ || Object.getPrototypeOf(e2)).call.apply(t3, [this].concat(l2))), i2.onCreate = function() {
        ...
        var r = n(37), i = n.n(r), a = n(33), s = n(34), u = n(36), c = n(35), l = { DisplaySize: s.a, Toolbar: u.a, Resize: c.a }, f = function t2(e2) {
          ...
          var s2 = false;
          r2.modules && (s2 = r2.modules.slice()), this.options = i()({}, r2, a.a), s2 !== false && (this.options.modules = s2), document.execCommand("enableObjectResizing", false, "false"), this.quill.root.addEventListener("click", this.handleClick, false), this.quill.root.parentNode.style.position = this.quill.root.parentNode.style.position || "relative", this.moduleClasses = this.options.modules, console.log("this.options.modules", this.options.modules), this.modules = [];
        };
        ...
        function o(t2, e2) {
          ...
          for (var v in t2) !e2 && !f.call(t2, v) || d && ("length" == v || l2 && ("offset" == v || "parent" == v) || p && ("buffer" == v || "byteLength" == v || "byteOffset" == v) || u(v, y)) || h.push(v);
          return h;
        }
...
//# sourceMappingURL=quill-image-resize-module.js.map
