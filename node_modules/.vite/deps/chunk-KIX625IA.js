import {
  ...
  memoize_default,
  merge_default
} from "./chunk-RUPCYR7B.js";
import {
  require_dist
} from "./chunk-ODXXRYZO.js";
import {
  __commonJS,
  __toESM
...
var character = 0;
var characters = "";
function node(value, root2, parent, type3, props, children2, length2, siblings) {
  return { value, root: root2, parent, type: type3, props, children: children2, line, column, length: length2, return: "", siblings };
}
function char() {
  return character;
}
    ...
    switch (previous = character2, character2 = next()) {
      ...
      case 0:
        switch (character2) {
          ...
          // { rule/at-rule
          default:
            append2(reference = ruleset(characters2, root2, parent, index2, offset, rules, points, type3, props = [], children2 = [], length2, rulesets), rulesets);
            if (character2 === 123)
              if (offset === 0)
...
function ruleset(value, root2, parent, index2, offset, rules, points, type3, props, children2, length2, siblings) {
  var post = offset - 1;
  ...
  for (var i = 0, j = 0, k2 = 0; i < index2; ++i)
    for (var x3 = 0, y3 = substr(value, post + 1, post = abs5(j = points[i])), z = value; x3 < size; ++x3)
      if (z = trim(j > 0 ? rule[x3] + " " + y3 : replace(y3, /&\f/g, rule[x3])))
        props[k2++] = z;
  return node(value, root2, parent, offset === 0 ? RULESET : type3, props, children2, length2, siblings);
}
...
var renderKatex = async (text2, config2) => {
  ...
  const { default: katex } = await import("./katex-QYRWWQ3W.js");
...
var loader$m = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-3d4e48cf-QHVR54N2.js");
...
var loader$l = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-66a62f08-LHGY4DNQ.js");
...
var loader$k = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-96b9c2cf-D5VC6KB3.js");
...
var loader$j = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-9861fffd-7FKKPNO6.js");
...
var loader$i = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-72cf32ee-JC7IPLNL.js");
...
var loader$h = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-c361ad54-U6IRGDXD.js");
...
var loader$g = async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-f8f76790-6ZDI5DOX.js");
...
var loader$f = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-8a3498a8-L6VIE4MB.js");
...
var loader$e = async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-120e2f19-BEJ3WLXD.js");
...
var loader$d = async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-e933f94c-HY3IGX3G.js");
...
var loader$c = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-deff3bca-4Q75Z6WL.js");
...
var loader$b = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-704730f1-BEHXTYDE.js");
...
var loader$a = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-70f12bd4-2PGZOPVS.js");
...
var loader$9 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-f2320105-RBL5VROH.js");
...
var loader$8 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-587899a1-NTTM4QMY.js");
...
var loader$7 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-d93cdb3a-HUMII2NC.js");
...
var loader$6 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-49397b02-4IBLNFWF.js");
...
var loader$5 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-4a651766-PZSXBPLG.js");
...
var loader$4 = async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-85554ec2-L5V45VS4.js");
...
var loader$3 = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-fc14e90a-K652URD3.js");
...
var loader$2 = async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-04a897e0-7G74EL2U.js");
...
var loader$1 = async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-38ab4fdb-AD4YE3SD.js");
...
var render$1 = async function(id22, text2, svgContainingElement) {
  ...
  if (svgContainingElement !== void 0) {
    ...
    if (isSandboxed) {
      ...
      root2 = select_default2(iframe.nodes()[0].contentDocument.body);
      root2.node().style.margin = 0;
    } else {
      root2 = select_default2(svgContainingElement);
    }
    appendDivSvgG(root2, id22, enclosingDivID, `font-family: ${fontFamily}`, XMLNS_XLINK_STD);
  } else {
    ...
    if (isSandboxed) {
      ...
      root2 = select_default2("body");
    }
    appendDivSvgG(root2, id22, enclosingDivID);
  }
  let diag;
  ...
  root2.select(`[id="${id22}"]`).selectAll("foreignobject > *").attr("xmlns", XMLNS_XHTML_STD);
...
mermaid/dist/mermaid-b5860b54.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KIX625IA.js.map
